...
//  ListApp
//
//  Created by SAFA HELVACI on 9.09.2022.
//
...
class ViewController: UIViewController {
    ...
    @IBAction func didRemoveBarButtonItemTapped(_ sender:UIBarButtonItem){
        presentAlert(title: "Uyarı!",
                     ...
                     defaultButtonTitle: "Evet", cancelButtonTitle: "Vazgeç",
    ...
    @IBAction func didAddBarItemTapped(_ sender: UIBarButtonItem){
            presentAddAlert()
        }
    ...
    func presentAddAlert(){
        ...
        presentAlert(title: "Yeni Eleman Ekle",
                     ...
                     cancelButtonTitle: "Vazgeç", isTextFieldAvailable: true, defaultButtonHandler: { _ in
